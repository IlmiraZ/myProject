...
import ru.ilmira.myProject.auth.AuthCreator;
...
import static ru.ilmira.myProject.auth.AuthCreator.*;
import static ru.ilmira.myProject.util.token.RefreshTokenCreator.createRefreshTokenDto;
import static ru.ilmira.myProject.util.user.UserCreator.createUser;
